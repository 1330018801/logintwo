 ...
 */
public class Aftercare4To6Year extends Aftercare3To6YearActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Aftercare4To6Year.this, ServicesActivity.class);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (!obj.getBoolean("error")) {
                                    ...
                                    TextView eye_sight = (TextView) findViewById(R.id.eye_sight);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(Aftercare4To6Year.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
