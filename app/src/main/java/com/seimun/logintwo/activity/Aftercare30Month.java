 ...
 */
public class Aftercare30Month extends Aftercare12To30MonthActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Aftercare30Month.this, ServicesActivity.class);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(Aftercare30Month.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
