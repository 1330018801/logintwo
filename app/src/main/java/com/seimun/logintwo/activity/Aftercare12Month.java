 ...
 */
public class Aftercare12Month extends Aftercare12To30MonthActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Aftercare12Month.this, ServicesActivity.class);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(Aftercare12Month.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
