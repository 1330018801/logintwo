...
public class HypertensionAftercare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hypertension_aftercare);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (!obj.getBoolean("error")) {
                                    ...
                                    TextView sign_heart_rhythm = (TextView) findViewById(R.id.sign_heart_rhythm);
                                    ...
                                    TextView life_style_guide_salt = (TextView) findViewById(R.id.life_style_guide_salt);
                                    life_style_guide_salt.setText(detail.getString("life_style_guide_salt"));
                                    TextView life_style_guide_salt_next = (TextView) findViewById(R.id.life_style_guide_salt_next);
                                    ...
                                    TextView auxiliary_examination = (TextView) findViewById(R.id.auxiliary_examination);
