 ...
 */
public class Aftercare8Month extends Aftercare1To8MonthActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Aftercare8Month.this, ServicesActivity.class);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(Aftercare8Month.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
